...
//CABECERA
$query = "SELECT k.*,DATE_FORMAT(fecha,'%d-%m-%Y')as date FROM kardex k where k.estado='0' AND k.tipo='DEVOLUCIÓN' AND k.refe_1='$folio' GROUP BY refe_1 ORDER BY id_kax ASC";
      $resultado = mysqli_query($conexion, $query);
    $data = mysqli_fetch_array($resultado);
    
    //CARCTERES SELECT LEN(MyColumna) FROM MyTabla
   $querycar = "SELECT CHAR_LENGTH(refe_1) as caracter, refe_1 FROM kardex k where k.estado='0' AND k.tipo='DEVOLUCIÓN' AND k.refe_1='$folio' GROUP BY refe_1 ORDER BY id_kax ASC";
    $resucar = mysqli_query($conexion, $querycar);

//TABLA DE EXTENDIDO
$query1 = "SELECT * FROM kardex k, articulos a where k.tipo='DEVOLUCIÓN' AND a.artcodigo=k.codigo_1 AND k.refe_1='$folio' ORDER BY k.id_kax ASC";
...
<body>
    ...
    <p style="font-weight:bold; font-size:23px; text-align:center;padding-top:-2.3%;">DEVOLUCIÓN</p>
