...
<head>
    ...
    <title>FORMATO DE MATRIAL FALTANE <?php echo $data['refe_1']?></title>
...
<body>
    ...
    <p style="font-weight:bold; font-size:23px; text-align:center;padding-top:-2.3%;">MATERIAL FALTANTE</p>
