...
//TABLA DE EXTENDIDO
$query1 = "SELECT * FROM historial WHERE proceso LIKE '%PEDIDO%' AND registro LIKE '%$folio%' ORDER BY id_his";
...
<body>
    ...
    <p style="font-weight:bold; font-size:23px; text-align:;padding-top:1.5%;">VALE DE OFICINA FOLIO: <?php echo $data['refe_1']?></p>
    ...
    <?php
            ...
            $dompdf->render();
            $dompdf->stream("HISTORIAL VALE DE OFICINA", array("Attachment" => 0));
            $pdf = $dompdf->output();
        ?>
</body>
</html>