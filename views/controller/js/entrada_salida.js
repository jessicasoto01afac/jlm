...
function foliodevolution() {
    ...
    let tipo = "DEVOLUCIÓN"
        //--------------------------
    let datos = 'tipo=' + tipo + '&opcion=gefoliodv';
    //alert(datos);
    $.ajax({
        type: "POST",
        url: "../controller/php/insertsalidentra.php",
...
function addmatdevolucion() {
    //alert("entro agregar vale de producción");
    let refe_1 = document.getElementById('dvfolio').value;
    let fecha = document.getElementById('dvfecha').value;
    let descripcion_1 = document.getElementById('dvmotivo').value;
    let proveedor_cliente = document.getElementById('dvcliente').value;
    let codigo_1 = document.getElementById('mcodigotr').value;
    let cantidad_real = document.getElementById('dvcantidad').value;
    let salida = document.getElementById('dvcantidad').value;
    let observa = document.getElementById('dvbservo').value;
    //let refe_3 = document.getElementById('estadodef').value;
    let refe_2 = document.getElementById('dvfdeped').value;
    //let ubicacion = document.getElementById('pedidomem').value;
    //let caracter = document.getElementById('vpcaracter').value;
    //multiselect de pedido-----
    var tPrfil = ''
    ...
    ubicacion = tPrfil.substr(1);
    let datos = 'refe_1=' + refe_1 + '&refe_2=' + refe_2 + '&fecha=' + fecha + '&descripcion_1=' + descripcion_1 + '&proveedor_cliente=' + proveedor_cliente + '&codigo_1=' + codigo_1 + '&cantidad_real=' + cantidad_real + '&salida=' + salida + '&observa=' + observa + '&ubicacion=' + ubicacion + '&opcion=registrardv';
    //alert(datos);
    if (refe_1 == '' || fecha == '' || proveedor_cliente == '' || codigo_1 == '') {
        document.getElementById('vaciosdf').style.display = ''
        setTimeout(function() {
...
function updatedefectdv() {
    ...
    document.getElementById('dvbservo').value = "";
    //document.getElementById('dvfdeped').value = "";
    //INFORMACION DE LAS TBLAS
    let id_valeproduc = document.getElementById('dvfolio').value;
    let folio = document.getElementById('dvfolio').value;
    //alert(folio);
    $.ajax({
    ...
    $(document).ready(function() {
        ...
        $('#wizard5').steps({
            ...
            onFinished: function(event, currentIndex) {
                ...
                let refe_1 = document.getElementById('dvfolio').value;
                let fecha = document.getElementById('dvfecha').value;
                let deptamt = document.getElementById('dvfdeped').value;
                let cliente = document.getElementById('dvcliente').value;
                //alert(datos);
                if (refe_1 == '' || fecha == '' || deptamt == '' || cliente == '') {
                    document.getElementById('vaciosdf').style.display = ''
                    setTimeout(function() {
...
function savedevhead() {
    ...
    var refe_2 = document.getElementById('infdepmd').value;
    var proveedor_cliente = document.getElementById('infclinte').value;
    var datos = 'fecha=' + fecha + '&descripcion_1=' + descripcion_1 + '&refe_2=' + refe_2 + '&ubicacion=' + ubicacion + '&refe_1=' + refe_1 + '&proveedor_cliente=' + proveedor_cliente + '&opcion=cambiocabdv';
    //alert(datos);
    if (document.getElementById('fmdi').value == '' || document.getElementById('infdepmd').value == '' || document.getElementById('infclinte').value == '') {
        document.getElementById('edthvoivacios').style.display = '';
        setTimeout(function() {
...
function foliomatfalt() {
    ...
    let tipo = "MATERIAL_FALTANTE"
        //--------------------------
    let datos = 'tipo=' + tipo + '&opcion=gefolioflt';
    //alert(datos);
    $.ajax({
        type: "POST",
        url: "../controller/php/insertsalidentra.php",
...
function addmatfaltan() {
    ...
    let refe_2 = document.getElementById('faldeped').value;
    let fecha = document.getElementById('falfecha').value;
    let proveedor_cliente = document.getElementById('faltcliente').value;
    let codigo_1 = document.getElementById('mcodigotr').value;
    let cantidad_real = document.getElementById('vpcantidad').value;
    let salida = document.getElementById('vpcantidad').value;
    let observa = document.getElementById('faltbservo').value;
    let datos = 'refe_1=' + refe_1 + '&refe_2=' + refe_2 + '&fecha=' + fecha + '&proveedor_cliente=' + proveedor_cliente + '&codigo_1=' + codigo_1 + '&cantidad_real=' + cantidad_real + '&salida=' + salida + '&observa=' + observa + '&opcion=registrarflt';
    //alert(datos);
    if (refe_1 == '' || fecha == '' || proveedor_cliente == '' || codigo_1 == '') {
        document.getElementById('vaciosdf').style.display = ''
        setTimeout(function() {
    ...
    $(document).ready(function() {
        ...
        $('#wizard5').steps({
            ...
            onFinished: function(event, currentIndex) {
                ...
                let refe_1 = document.getElementById('falfolio').value;
                let fecha = document.getElementById('falfecha').value;
                let deptamt = document.getElementById('faldeped').value;
                let cliente = document.getElementById('faltcliente').value;
                //alert(datos);
                if (refe_1 == '' || fecha == '' || deptamt == '' || cliente == '') {
                    document.getElementById('vaciosdf').style.display = ''
                    setTimeout(function() {
