...
function openew() {
  ...
  $(document).ready(function () {
    ...
    $('#cmprovedd').change(function () {
      var folio = document.getElementById('cmprovedd').value; //alert(folio);
  ...
  $.ajax({
    ...
    for (C = 0; C < res.length; C++) {
      if (obj.data[C].folio_oc == id_produc) {
        ...
        document.getElementById('relajlcmp').value = obj.data[C].revision;
        ...
        if (obj.data[C].estatus === 'AUTORIZADO') {
          ...
          $.ajax({
            ...
            for (U = 0; U < res.length; U++) {
              ...
              if (obj.data[U].estatuskardex == "0") {
                accions = "<span style='cursor:pointer;' type='button' onclick='edithsurcopr(" + id_valepro + ");' class='pendiente' title='Sin entradas'>Sin Entrada</span>";
              } else if (obj.data[U].estatuskardex == "1") {
                accions = "<span style='cursor:pointer;' title='Ya fue surtido' onclick='infsurto(" + id_valepro + ")' data-toggle='modal' data-target='#modal-surtido' class='spandis'>COMPLETADO</span>";
              } else if (obj.data[U].estatuskardex == "2") {
                accions = "<button type='button' onclick='entradaparcial(" + id_valepro + ");' class='btn btn-info mg-b-10' title='Dar click para surtir' data-toggle='modal' data-target='#modal-entradaparcial'>ENTRADA PARCIAL</button>";
              }
...
function updatdetll() {
  //INFO DE ARTICULOS 
  var id_cmmpp = document.getElementById('ordncompras').innerHTML;
  $.ajax({
    url: '../controller/php/infcompras.php',
    type: 'GET',
    data: 'folio=' + id_cmmpp
...
function confirmsurt() {
  ...
  var cond_pago = document.getElementById('condcm').value;
  var asignado = document.getElementById('consignada').value;
  var id_articulo = document.getElementById('codisurtjlm').value;
  var id_artprove = document.getElementById('codisurtprove').value;
  var cantidad = document.getElementById('surtartcm').value;
  var observación = document.getElementById('surbsereped').value;
  var id_comp = document.getElementById('id_surtarcm').value;
  var comparcant = document.getElementById('surtartcm2').value;
  var datos = 'folio=' + folio + '&id_comp=' + id_comp + '&fecha=' + fecha + '&comparcant=' + comparcant + '&fecha_entrga=' + fecha_entrga + '&id_proveedor=' + id_proveedor + '&uso_CFDI=' + uso_CFDI + '&cond_pago=' + cond_pago + '&asignado=' + asignado + '&id_articulo=' + id_articulo + '&id_artprove=' + id_artprove + '&cantidad=' + cantidad + '&observación=' + observación + '&opcion=entrada'; //alert(datos);
  ...
  $.ajax({
    ...
    for (C = 0; C < res.length; C++) {
      if (obj.data[C].id_comp == id_surtido) {
        ...
        document.getElementById('cnsurt').value = obj.data[C].entradarel;
        document.getElementById('obdepinf').value = obj.data[C].observación; //document.getElementById('cantidadreal').innerHTML = obj.data[C].cantidadreal;
      }
    }
  });
...
function savesurtcm() {
  var refe_2 = document.getElementById('idsurt').value;
  var refe_1 = document.getElementById('ordncompras').innerHTML;
  var cantidad = document.getElementById('cnsurt').value;
  var cantidadreal = document.getElementById('cartsur2').innerHTML;
  var observa_dep = document.getElementById('obdepinf').value;
  var datos = 'refe_2=' + refe_2 + '&refe_1=' + refe_1 + '&cantidad=' + cantidad + '&cantidadreal=' + cantidadreal + '&observa_dep=' + observa_dep + '&opcion=entradaeth'; //alert(datos);
  ...
  if (refe_2 == '' || refe_1 == '' || cantidad == '') {
    ...
    $.ajax({
      ...
      if (respuesta == 0) {
        ...
        closedithsurt();
        updatdetll();
        $('#modal-surtido').modal('hide'); //cierra el modal
      } else if (respuesta == 2) {
        document.getElementById('edthdcppblinf').style.display = '';
        setTimeout(function () {
          document.getElementById('edthdcppblinf').style.display = 'none';
  ...
  $.ajax({
    ...
    for (C = 0; C < res.length; C++) {
      if (obj.data[C].id_comp == idartprov) {
        (function () {
          //alert("entro");
          var total = obj.data[C].entradarel;
...
function confirmsurtparc() {
  ...
  var folio = document.getElementById('ordncompras').innerHTML;
  var id_articulo = document.getElementById('codisurtjlm2').value;
  var id_artprove = document.getElementById('codisurtprove2').value;
  var cantidad = document.getElementById('id_surtarcm2oc').value;
  var observación = document.getElementById('surbsereped2').value;
  var id_comp = document.getElementById('id_surtarcm2').value;
  var total = document.getElementById('surtartcm3').value;
  var estatukardex = '';
  ...
  var datos = 'folio=' + folio + '&id_comp=' + id_comp + '&total=' + total + '&estatukardex=' + estatukardex + '&id_articulo=' + id_articulo + '&id_artprove=' + id_artprove + '&cantidad=' + cantidad + '&observación=' + observación + '&opcion=entradaparcial'; //alert(datos);
...
function finalizarcm() {
  var folio = document.getElementById('ordncompras').innerHTML;
  var datos = 'folio=' + folio + '&opcion=finalizarcm';
  alert(datos);
  ...
  $.ajax({
    ...
    for (C = 0; C < res.length; C++) {
      if (obj.data[C].id_comp == id_surtido) {
        ...
        document.getElementById('opstsur').innerHTML = obj.data[C].observación;
        document.getElementById('cnsurt').value = obj.data[C].entradarel;
        document.getElementById('obdepinf').value = obj.data[C].observación;
        document.getElementById('opesurt1').style.display = 'none';
        $('#opesurt1').addClass("hiddden");
      }
    }
  });
}