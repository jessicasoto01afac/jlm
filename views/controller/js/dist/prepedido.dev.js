...
function wizzar() {
  ...
  $('#wizard5').steps({
    ...
    onFinished: function onFinished(event, currentIndex) {
      ...
      var refe_1 = document.getElementById('prepedfolio').value;
      var fecha = document.getElementById('predfecha').value;
      var refe_3 = document.getElementById('predpedidatentio').value;
      var proveedor_cliente = document.getElementById('predpedicliente').value;
      var caracter = document.getElementById('prepedidcaracter').value; //--------------------------
...
function addprepedido() {
  ...
  var referencia = document.getElementById('prepedfolio').value;
  var fecha = document.getElementById('predfecha').value;
  var atendio = document.getElementById('predpedidatentio').value;
  var cliente = document.getElementById('predpedicliente').value;
  var caracter = document.getElementById('prepedidcaracter').value;
  var codigo = document.getElementById('mcodigotrpre').value;
  var cantidad = document.getElementById('prepedcantidad').value;
  var observa = document.getElementById('prepedbservo').value;
  var descripcion_1 = document.getElementById('mcodigotrpre').value;
  var lugar = document.getElementById('addlugarpre').value;
  var direccion = document.getElementById('adddireccionpre').value; //--------------------------

  var datos = 'referencia=' + referencia + '&fecha=' + fecha + '&atendio=' + atendio + '&cliente=' + cliente + '&caracter=' + caracter + '&codigo=' + codigo + '&cantidad=' + cantidad + '&descripcion_1=' + descripcion_1 + '&observa=' + observa + '&lugar=' + lugar + '&direccion=' + direccion + '&opcion=registrarpre'; //alert(datos);
...
function updateprepedido() {
  ...
  document.getElementById('prepedbservo').value = ""; //INFORMACION DE LAS TBLAS

  var id_pedid = document.getElementById('prepedfolio').value;
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      if (obj.data[U].referencia == id_pedid) {
        x++;
        var id_prepedidd = obj.data[U].id_pre;
...
function cancelar() {
  ...
  var refe_1 = document.getElementById('prepedfolio').value;
  var datos = 'refe_1=' + refe_1 + '&opcion=cancelarpre';
  $.ajax({
    type: "POST",
    url: "../controller/php/insertpedio.php",
    data: datos
...
function savedithdettpred() {
  var id_pre = document.getElementById('id_prededithdett').value;
  var codigo = document.getElementById('dedttprededith').value;
  var cantidad = document.getElementById('prededettcant').value;
  var observa = document.getElementById('pedobsadddetll').value;
  var datos = 'cantidad=' + cantidad + '&observa=' + observa + '&id_pre=' + id_pre + '&codigo=' + codigo + '&opcion=updatearprepinfo'; //alert(datos);
...
function savdelevpartpred() {
  var id_pre = document.getElementById('del_artprednew').value;
  var codigo = document.getElementById('deartprednew').value;
  var datos = 'id_pre=' + id_pre + '&codigo=' + codigo + '&opcion=deleartprenew'; //alert(datos);
...
function infpredido(pruebas) {
  ...
  $.ajax({
    ...
    for (D = 0; D < res.length; D++) {
      if (obj.data[D].referencia == pruebas) {
        //auropedid
        ...
        if (obj.data[D].status == 'PENDIENTE') {
          ...
          var masivo = $("#masivo").addClass("d-none");
          ...
          $.ajax({
            ...
            for (U = 0; U < res.length; U++) {
              if (obj.data[U].referencia == pruebas) {
                x++;
                var id_kardex = obj.data[U].id_pre;
...
function updateprepedido2() {
  ...
  document.getElementById('ppinfbsertrass').value = ""; //INFORMACION DE LAS TBLAS

  var id_pedid = document.getElementById('idinped').innerHTML;
  var folio = id_pedid; //alert(folio);
...
function addarinpredinfo() {
  //alert("entro agregar vale de producción");
  var referencia = document.getElementById('idinped').innerHTML;
  var fecha = document.getElementById('infvpdate').value;
  var cliente = document.getElementById('infclinte').value;
  var atendio = document.getElementById('atendioinf').value;
  var lugar = document.getElementById('infpedlugar').value;
  var direccion = document.getElementById('infpeddirect').value;
  var caracter = document.getElementById('pedidcaracter').value;
  var codigo = document.getElementById('codindivinf').value;
  var cantidad = document.getElementById('pincantidinf').value;
  var observa = document.getElementById('ppinfbsertrass').value;
  var datos = 'referencia=' + referencia + '&fecha=' + fecha + '&cliente=' + cliente + '&atendio=' + atendio + '&lugar=' + lugar + '&direccion=' + direccion + '&caracter=' + caracter + '&codigo=' + codigo + '&cantidad=' + cantidad + '&observa=' + observa + '&opcion=registrarindpre'; //alert(datos);
...
function converpedido() {
  ...
  var datos = 'folio=' + folio + '&opcion=conpedido'; //alert(datos);
...
function savedithinfpred() {
  var id_pre = document.getElementById('id_prededithinf').value;
  var codigo = document.getElementById('deinfprededith').value;
  var cantidad = document.getElementById('predeinfcant').value;
  var observa = document.getElementById('pedobsaddinf').value;
  var datos = 'cantidad=' + cantidad + '&observa=' + observa + '&id_pre=' + id_pre + '&codigo=' + codigo + '&opcion=updatearprepinfo'; //alert(datos);
...
function savdelevpartpredinf() {
  var id_pre = document.getElementById('del_artpredinf').value;
  var codigo = document.getElementById('deartpredinf').value;
  var datos = 'id_pre=' + id_pre + '&codigo=' + codigo + '&opcion=deleartprenew'; //alert(datos);
...
function savepredcabe() {
  ...
  var datos = 'referencia=' + referencia + '&atendio=' + atendio + '&fecha=' + fecha + '&cliente=' + cliente + '&lugar=' + lugar + '&direccion=' + direccion + '&pedidcaracter=' + pedidcaracter + '&opcion=savecabezpre';
