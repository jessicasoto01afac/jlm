  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      ...
      if (obj.data[U].refe_1 == id_memo && obj.data[U].tipo == 'MEMO' && obj.data[U].tipo_ref == 'ARTICULO_TRANSFORMACION' && obj.data[U].status == 'PENDIENTE') {
        ...
        x++;
        $id_memo2 = obj.data[U].id_kax;
        html += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].salida + "</td></tr>"; //SURTIDO
    ...
    for (U = 0; U < res.length; U++) {
      ...
      if (obj.data[U].refe_1 == id_memo && obj.data[U].tipo == 'MEMO' && obj.data[U].tipo_ref == 'ARTICULO_TRANSFORMADO' && obj.data[U].status == 'PENDIENTE') {
        ...
        html2 += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].entrada + "</td><td class='dropdown hidden-xs-down'>" + "<a data-toggle='dropdown' class='btn pd-y-3 tx-gray-500 hover-info'><i class='icon ion-more'></i></a><div class='dropdown-menu dropdown-menu-right pd-10'><nav class='nav nav-style-1 flex-column'><a onclick='editarmemo2(" + $id_memo3 + ");' class='nav-link' data-toggle='modal' data-target='#modal-editarmemo'>Editar</a><a href='' onclick='delartmeminf2(" + $id_memo3 + ");'  class='nav-link' data-toggle='modal' data-target='#modal-deleteartif'>Eliminar</a>" + "</td></tr>"; //AUTORIZADO 2
        ...
        x++;
        $id_memo3 = obj.data[U].id_kax;
        html2 += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].entrada + "</td></tr>"; //finalizado 2
        ...
        x++;
        $id_memo3 = obj.data[U].id_kax;
        html2 += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].entrada + "</td></tr>"; //PENDIENTE 2
...
function autorizarm() {
  ...
  var datos = 'folio=' + folio + '&opcion=autorizarmem'; //alert(datos);
...
function surtirme() {
  ...
  var datos = 'folio=' + folio + '&opcion=surtirmem'; // alert(datos);
...
function savedemem() {
  ...
  var datos = 'pedido=' + pedido + '&opcion=deletememo'; //alert(datos);
...
function liberarm() {
  ...
  var datos = 'memo=' + memo + '&opcion=liberarmem'; //alert(datos);
  ...
  $.ajax({
    ...
    for (D = 0; D < res.length; D++) {
      ...
      if (obj.data[D].fecha_finalizacion != '0000-00-00') {
        ...
        document.getElementById('dias3').innerHTML = obj.data[D].dias_totales + " dias trascurridos para finalización "; //alert("0");
      }

      if (obj.data[D].fecha_finalizacion == '0000-00-00') {
        document.getElementById('dias1').innerHTML = obj.data[D].dias_autorizacion + " dias Creación/Autorización";
        document.getElementById('dias2').innerHTML = obj.data[D].dias_asurtdo + " dias Autorización/Surtido";
        document.getElementById('dias3').innerHTML = "Sin finalizar"; //alert("null");
      }
...
function editarmemo(id_memo) {
  ...
  var folio = id_memo; //alert(id_armemin1);
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      if (obj.data[U].id_kax == id_memo) {
        datos = obj.data[U].codigo_1 + '*' + obj.data[U].artdescrip + '*' + obj.data[U].salida + '*' + obj.data[U].ubicacion + '*' + obj.data[U].observa;
        var d = datos.split("*");
...
function editarmemoalt(id_memo) {
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      //alert(respuesta);
      if (obj.data[U].id_kax == id_memo) {
        datos = obj.data[U].codigo_1 + '*' + obj.data[U].descripcion_1 + '*' + obj.data[U].salida + '*' + obj.data[U].ubicacion + '*' + obj.data[U].observa;
        var d = datos.split("*");
...
function editarmemoalt2(id_memo) {
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      if (obj.data[U].id_kax == id_memo) {
        datos = obj.data[U].codigo_1 + '*' + obj.data[U].descripcion_1 + '*' + obj.data[U].entrada + '*' + obj.data[U].ubicacion + '*' + obj.data[U].observa;
        var d = datos.split("*");
        $("#modal-editarmemoalta #coditrasal").val(d[0]);
        $("#modal-editarmemoalta #mdestrasp").val(d[1]);
        $("#modal-editarmemoalta #editcamemalt").val(d[2]);
...
function edithartalta() {
  ...
  $("#datamemo tr").on('click', function () {
    ...
    document.getElementById('id_meminf').value = id_alttras; //alert(id_alttras);
...
function editarmemo2(id_memos) {
  ...
  document.getElementById('closeditmemartinf_v2').style.display = 'none';
  var folio = id_memos;
  document.getElementById('id_meminf').value = id_memos; //alert(id_armemin2);
...
function editartmemoalv2() {
  //alert("edit articulo infovalesds");
  document.getElementById('closeditrasv2').style.display = "";
  document.getElementById('openeditrasv2').style.display = "none";
  document.getElementById('memguardaralv2').style.display = "";
  document.getElementById('editcamemalt').disabled = false;
  document.getElementById('bseremealt').disabled = false;
  document.getElementById('coditrasal').disabled = false;
} //FUNIÓN PARA CERRAR LA EDICIÓN EN ARTICULOS MEMO ALTA MEMO
...
function closeditmemalv2() {
  //alert("edit articulo infovalesds");
  document.getElementById('closeditrasv2').style.display = "none";
  document.getElementById('openeditrasv2').style.display = "";
  document.getElementById('memguardaralv2').style.display = "none";
  document.getElementById('editcamemalt').disabled = true;
  document.getElementById('bseremealt').disabled = true;
  document.getElementById('coditrasal').disabled = true;
...
function editartmemoinf_v2() {
  //alert("edit articulo infovalesds");
  document.getElementById('closeditmemartinf_v2').style.display = "";
  document.getElementById('openedimemarinf_v2').style.display = "none";
  document.getElementById('memguardarinf_v2').style.display = "";
  document.getElementById('editcameminf').disabled = false;
  document.getElementById('infobsereme').disabled = false;
  document.getElementById('arsurmem').disabled = false;
} //FUNIÓN PARA CERRAR LA EDICIÓN EN ARTICULOS MEMO VISTA DE INFORMACIÓN
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      ...
      if (obj.data[U].refe_1 == refe_1 && obj.data[U].tipo == 'MEMO' && obj.data[U].tipo_ref == 'ARTICULO_TRANSFORMACION' && obj.data[U].status == 'PENDIENTE') {
        x++;
        $id_memo2 = obj.data[U].id_kax;
        html += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].salida + "</td><td class='dropdown hidden-xs-down responsive'>" + "<a data-toggle='dropdown' class='btn pd-y-3 tx-gray-500 hover-info'><i class='icon ion-more'></i></a><div class='dropdown-menu dropdown-menu-right pd-10 responsive'><nav class='nav nav-style-1 flex-column'><a onclick='editarmemo(" + $id_memo2 + ");' class='nav-link' data-toggle='modal' data-target='#modal-editarmemo'>Editar</a><a href='' onclick='delartmeminf(" + $id_memo2 + ");'  class='nav-link' data-toggle='modal' data-target='#modal-deleteartif'>Eliminar</a>" + "</td></tr>"; //finalizado
  ...
  $.ajax({
    ...
    for (U = 0; U < res.length; U++) {
      ...
      if (obj.data[U].refe_1 == refe_1 && obj.data[U].tipo == 'MEMO' && obj.data[U].tipo_ref == 'ARTICULO_TRANSFORMADO' && obj.data[U].status == 'PENDIENTE') {
        x++;
        $id_memo3 = obj.data[U].id_kax;
        html += "<tr><td>" + x + "</td><td>" + obj.data[U].id_kax + "</td><td>" + obj.data[U].codigo_1 + "</td><td>" + obj.data[U].artdescrip + "</td><td>" + obj.data[U].observa + "</td><td>" + obj.data[U].entrada + "</td><td class='dropdown hidden-xs-down'>" + "<a data-toggle='dropdown' class='btn pd-y-3 tx-gray-500 hover-info'><i class='icon ion-more'></i></a><div class='dropdown-menu dropdown-menu-right pd-10'><nav class='nav nav-style-1 flex-column'><a onclick='editarmemo2(" + $id_memo3 + ");' class='nav-link' data-toggle='modal' data-target='#modal-editarmemo'>Editar</a><a href='' onclick='delartmeminf2(" + $id_memo3 + ");'  class='nav-link' data-toggle='modal' data-target='#modal-deleteartif'>Eliminar</a>" + "</td></tr>"; //finalizado
...
function saveinfethmem() {
  ...
  var refe_1 = document.getElementById('folmemo').innerHTML;
  var id_kax = document.getElementById('id_meminf').value;
  var codigo_1 = document.getElementById('arsurmem').value;
  var descripcion_1 = document.getElementById('edithmeades').value;
  var salida = document.getElementById('editcameminf').value;
  var observa = document.getElementById('infobsereme').value;
  var datos = 'codigo_1=' + codigo_1 + '&descripcion_1=' + descripcion_1 + '&salida=' + salida + '&observa=' + observa + '&id_kax=' + id_kax + '&refe_1=' + refe_1 + '&opcion=actualizainf'; //alert(datos);
...
function saveinfethmem2() {
  ...
  var salida = document.getElementById('editcameminf').value;
  var observa = document.getElementById('infobsereme').value;
  var datos = 'codigo_1=' + codigo_1 + '&descripcion_1=' + descripcion_1 + '&salida=' + salida + '&observa=' + observa + '&id_kax=' + id_kax + '&refe_1=' + refe_1 + '&opcion=actualizainfv2'; //alert(datos);
...
function savealtethmem() {
  //alert("entra guardar cambios memeo");
  var refe_1 = document.getElementById('mfolio').value;
  var id_kax = document.getElementById('id_memtrass').value;
  var codigo_1 = document.getElementById('coditrasal').value;
  var descripcion_1 = document.getElementById('mdestrasp').value;
  var salida = document.getElementById('editcamemalt').value;
  var observa = document.getElementById('bseremealt').value;
  var datos = 'codigo_1=' + codigo_1 + '&descripcion_1=' + descripcion_1 + '&salida=' + salida + '&observa=' + observa + '&id_kax=' + id_kax + '&refe_1=' + refe_1 + '&opcion=actualizainf'; //alert(datos);
...
function delartmeminf(id_memo) {
  ...
  document.getElementById('del_artmeminf').value = id_memo; //alert(memfi);
...
function delartmeminf2(id_memo) {
  ...
  var folio = id_memo;
  document.getElementById('del_artmeminf').value = id_memo; //alert(memfi1);
...
function savdelemeinf() {
  ...
  var id_kax = document.getElementById('del_artmeminf').value;
  var refe_1 = document.getElementById('folmemo').innerHTML;
...
function savdelemeal() {
  ...
  var id_kax = document.getElementById('del_artmemalt').value;
  var refe_1 = document.getElementById('deartmeal').value;
  var datos = '&id_kax=' + id_kax + '&refe_1=' + refe_1 + '&opcion=delinfarm'; //alert(datos);
...
function desartrasmem() {
  ...
  var codivo = document.getElementById('coditrasmem').value;
  $.ajax({
...
function destrasmemalt() {
  //alert("eentraarticulo")
  var codivo = document.getElementById('coditrasal').value;
  $.ajax({
    url: '../controller/php/conarticulos.php',
    type: 'POST'
  }).done(function (respuesta) {
...
function addartimetras() {
  ...
  var datos = 'refe_1=' + refe_1 + '&fecha=' + fecha + '&refe_3=' + refe_3 + '&proveedor_cliente=' + proveedor_cliente + '&codigo_1=' + codigo_1 + '&descripcion_1=' + descripcion_1 + '&cantidad_real=' + cantidad_real + '&salida=' + salida + '&observa=' + observa + '&ubicacion=' + ubicacion + '&refe_2=' + refe_2 + '&opcion=registar3'; //alert(datos);
...
function addartimetrasps() {
  ...
  var ubicacion = document.getElementById('mdepartras').value;
  var refe_2 = document.getElementById('memorefeped').value;
  var datos = 'refe_1=' + refe_1 + '&fecha=' + fecha + '&refe_3=' + refe_3 + '&proveedor_cliente=' + proveedor_cliente + '&codigo_1=' + codigo_1 + '&descripcion_1=' + descripcion_1 + '&cantidad_real=' + cantidad_real + '&salida=' + salida + '&observa=' + observa + '&ubicacion=' + ubicacion + '&refe_2=' + refe_2 + '&opcion=registar4'; //alert(datos);
...
function savecamem() {
  ...
  var datos = 'fecha=' + fecha + '&refe_3=' + refe_3 + '&status=' + status + '&refe_1=' + refe_1 + '&refe_2=' + refe_2 + '&proveedor_cliente=' + proveedor_cliente + '&opcion=cambiocab'; //alert(datos);
...
function saverevicionmem() {
  var refe_1 = document.getElementById('folmemo').innerHTML;
  var revision = document.getElementById('relajlmem').value;
