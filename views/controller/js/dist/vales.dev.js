...
function delartvalofiadd() {
  ...
  $("#datavaofi1 tr").on('click', function () {
    ...
    document.getElementById('del_artvoalt').value = valof; //alert(memfi);
...
function editarvo() {
  ...
  $("#datavaofi1 tr").on('click', function () {
    ...
    document.getElementById('id_vo').value = id_valofi; //alert(id_valofi);
    ...
    $.ajax({
      ...
      for (U = 0; U < res.length; U++) {
        if (obj.data[U].id_kax == id_valofi) {
          datos = obj.data[U].codigo_1 + '*' + obj.data[U].descripcion_1 + '*' + obj.data[U].salida + '*' + obj.data[U].id_kax + '*' + obj.data[U].observa;
          var d = datos.split("*");
    ...
    $.ajax({
      ...
      for (D = 0; D < res.length; D++) {
        if (obj.data[D].refe_1 == id_vofi) {
          document.getElementById('relajlvof').value = obj.data[D].revision;
          datos = obj.data[D].fecha + '*' + obj.data[D].refe_3 + '*' + obj.data[D].proveedor_cliente + '*' + obj.data[D].status + '*' + obj.data[D].codigo_1;
          var o = datos.split("*");
...
function editarvoinf() {
  ...
  $("#infvaofi1 tr").on('click', function () {
    ...
    document.getElementById('id_voin').value = valofi1; //alert(valofi1);
...
function reloout() {
  ...
  $.ajax({
    ...
    var res = obj.data;
    var x = 0;
    html = '<div class="bd bd-gray-300 rounded table-responsive"><table style="width:100%" id="infvaofi1" name="infvaofi1" class="table display dataTable"><thead class="thead-colored thead-primary"><tr><th><i class="fa fa-sort-numeric-asc"></i>ID</th><th><i></i>CODIGO</th><th><i></i>DESCRIPCIÓN</th><th><i></i>OBSERVACIONES</th><th><i></i>CANTIDAD</th><th><i></i>CANTIDAD_SURTIDA</th><th style="width:20%;"><i></i>ESTATUS</th><th style="width:100px;"><i></i>ACCIONES</th></tr></thead><tbody>';
...
function delartvoinf() {
  ...
  $("#infvaofi1 tr").on('click', function () {
    ...
    document.getElementById('del_artvo').value = valofi1; //alert(valofi1);
...
function surtirvof() {
  ...
  $("#infvaofi1 tr").on('click', function () {
    ...
    document.getElementById('id_surtvof').value = vaof12; //alert(valofi1);
...
function infonosur() {
  ...
  $("#infvaofi1 tr").on('click', function () {
    ...
    document.getElementById('id_nosur').value = vaof12; //alert(valofi1);
    ...
    $.ajax({
      ...
      for (U = 0; U < res.length; U++) {
        if (obj.data[U].id_kax == vaof12) {
          datos = obj.data[U].codigo_1 + '*' + obj.data[U].descripcion_1 + '*' + obj.data[U].cantidad_real;
          var d = datos.split("*"); //$("#modal-nosurtido #arsurvof").val(d[0]);   
