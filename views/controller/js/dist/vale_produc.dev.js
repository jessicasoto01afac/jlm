...
function addvaleprodu() {
  ...
  var observa = document.getElementById('vpbservo').value; //let ubicacion = document.getElementById('pedidomem').value;

  var caracter = document.getElementById('vpcaracter').value; //multiselect de pedido-----
...
function valproduct(id_produc) {
  ...
  var pdfvp = document.getElementById('pdfvprod');
  $.ajax({
    ...
    for (D = 0; D < res.length; D++) {
      if (obj.data[D].refe_1 == id_produc) {
        ...
        document.getElementById('relajlm').value = obj.data[D].revision; //PENDIENTE-----------------------------------------------------------------------------------------------
...
function updatedvpdett() {
  ...
  var finalizado = document.getElementById('btnvpfinaliz');
  var editar = document.getElementById('openedivpinf');
  var pdfvp = document.getElementById('pdfvprod'); //alert(id_produc);
...
function infsiexvpfn(id_valeprodu) {
  ...
  var estatus = document.getElementById('infvpestatus').value; //estado
    ...
    for (C = 0; C < res.length; C++) {
      if (obj.data[C].id_kax == id_valeprodu) {
        if (document.getElementById('infvpestatus').value == "SURTIDO" || document.getElementById('infvpestatus').value == "FINALIZADO") {
          ...
          document.getElementById('obdepsinvpfn').innerHTML = obj.data[C].observa_dep; //inpus e edición

          document.getElementById('cnsinvpfn').value = obj.data[C].salida;
          document.getElementById('obdepsinvpfn').value = obj.data[C].observa_dep; //oculta la edición
          ...
          document.getElementById('cnsinvpfn').value = obj.data[C].salida;
          document.getElementById('obdepsinvpfn').value = obj.data[C].observa_dep; //muestra la edición
...
function closevaleproinf() {
  ...
  $("#infvpdaterecibio").attr("readonly", "readonly"); //$("#relajlm").attr("readonly", "readonly");
...
function savevrevicion() {
  var refe_1 = document.getElementById('folprod').innerHTML;
  var revision = document.getElementById('relajlm').value;
...
function savesinextvp() {
  ...
  var descrip = document.getElementById('descsinvp').innerHTML;
  var status2 = "SURTIDO"; //Condición de cambiar status2 si es mayor a 0
...
function savesinextvpfn() {
  //alert("entro vales");
  var id_kax = document.getElementById('idsinexvpfin').value;
  var refe_1 = document.getElementById('folprod').innerHTML;
  var cantidad = document.getElementById('cnsinvpfn').value;
  var observa_dep = document.getElementById('obdepsinvpfn').value;
  var descrip = document.getElementById('descsinvpfn').innerHTML;
  var status2 = "SURTIDO"; //Condición de cambiar status2 si es mayor a 0
  ...
  var datos = 'id_kax=' + id_kax + '&descrip=' + descrip + '&observa_dep=' + observa_dep + '&refe_1=' + refe_1 + '&cantidad=' + cantidad + '&status2=' + status2 + '&opcion=edthsinexisfin'; //alert(datos);
...
function savesurtvpfin() {
  ...
  var datos = 'id_kax=' + id_kax + '&descrip=' + descrip + '&observa_dep=' + observa_dep + '&refe_1=' + refe_1 + '&cantidad=' + cantidad + '&status2=' + status2 + '&opcion=edthsurtirfin'; //alert(datos);
...
function pdfvp() {
  var folio = document.getElementById('folprod').innerHTML; //alert("entro");
