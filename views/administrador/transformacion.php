...
?>
    ...
    <div class="br-mainpanel">
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">TRANSFORMACIÓN</h4>
        </div>

        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <a class="btn btn-primary" href="../administrador/newtrasn.php" style="float:right"><i
                        class="fa fa-plus mg-r-10"></i>Agregar Transformación</a>
                <br>
                <br>
                <br>
                <div class="rounded table-responsive">
                    <table class="table display dataTable" id="transfomacion" style="width:100%">
                        <thead>
                            <tr>
