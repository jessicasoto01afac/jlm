                ...
                <div class="row mg-b-25">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <select type="text" class="form-control inputalta" name="artunidad" id="artunidad" data-placeholder="Eliga una opción">
...
//agrega a base de datos de articulos
      function addPerson() {
       // alert("entra agregar articulos");
        ...
        var datos= 'artcodigo=' + artcodigo + '&artdescrip=' + artdescrip + '&artubicac=' + artubicac + '&artunidad=' + artunidad + '&artgrupo=' + artgrupo + '&opcion=registrar';
        //alert(datos);
        if (document.getElementById('artcodigo').value == '' || document.getElementById('artdescrip').value == '' || document.getElementById('artubicac').value == '' || document.getElementById('artunidad').value == '' || document.getElementById('artgrupo').value == '') {
