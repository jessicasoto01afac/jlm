                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control" onchange="edithextnewmd2()" id="cmpnewvpedi"
                                    name="cmpnewvpedi" type="text" disabled data-live-search="true"
                                    style="width: 100%">
                                    <option value="0">CODIGO</option>
                                    <?php while($arttras1 = mysqli_fetch_row($artiedidettvp)):?>
                                    <option value="<?php echo $arttras1[0]?>"><?php echo $arttras1[0]?></option>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label style="font-size:16px" class="form-control-label">CANTIDAD: <span
                                        class="tx-danger">*</span></label>
                                <input onkeyup="mayus(this);" class="form-control" name="cmedithcant"
                                    id="cmedithcant" placeholder="Ingrese la cantidad" disabled type="number"
                                    required>
                            </div><!-- form-group -->
                        </div><!-- form-group -->
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label style="font-size:16px" class="form-control-label">DEPARTAMENTO: <span
                                        class="tx-danger">*</span></label>
                                <input onkeyup="mayus(this);" class="form-control" name="cmedithdept"
                                    id="cmedithdept" placeholder="Departamento" readonly type="text" required>
                            </div><!-- form-group -->
                        </div><!-- form-group -->
                        <div class="col-lg-12">
                            <div class="form-group">
