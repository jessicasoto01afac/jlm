    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <a class="btn btn-primary" href="../administrador/newprove.php" style="float:right"><i
                        class="fa fa-cart-plus mg-r-10"></i>Agregar Proveedor</a>
                <br>
                <br>
                <br>
                <div class="rounded table-responsive">
                    <table class="table display dataTable" name="listpproveedor" id="listpproveedor" style="width:100%">
                        <thead>
                            <tr>
                                <th style="width:5%;">ID</th>
                                <th>CODIGO</th>
                                <th style="width:400px;">NOMBRE DEL PROVEEDOR</th>
                                <th>ACCIONES</th>
                            </tr>
                        </thead>
                    </table>
