    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <a class="btn btn-primary" href="../administrador/newclient.php" style="float:right"><i
                        class="fa fa-user-plus mg-r-10"></i>Agregar Cliente</a>
                <br>
                <br>
                <br>
                <div class="rounded table-responsive">
                    <table class="table display dataTable" name="listartic" id="listartic" style="width:100%">
                        <thead>
                            <tr>
                                <th style="width:5%;">ID</th>
                                <th>CODIGO</th>
                                <th style="width:400px;">NOMBRE DEL CLIENTE</th>
                                <th>RFC</th>
                                <th>ACCIONES</th>
                            </tr>
                        </thead>
