<?php include ("../../controller/conexion.php");
    ...
    ?>
			<select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)" onchange="desartic2()" id="mcodigotsp" name="mcodigotsp" type="text" data-live-search="true" style="width: 100%" >
	...
	<script type="text/javascript">
			...
			$('#mcodigotsp').change(function(){
				$.ajax({
					type:"post",
					data:'valor=' + $('#mcodigotsp').val(),
					url:'session/',
					success:function(r){
					}
				});
...
var codivo = document.getElementById('mcodigotsp').value; 
$.ajax({
