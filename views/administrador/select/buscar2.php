<?php include ("../../controller/conexion.php");
    ...
    ?>
			...
			<select class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)" onchange="desartic()" id="vcodigo1" name="vcodigo1" type="text" data-live-search="true" style="width: 100%" >
	...
	<script type="text/javascript">
			...
			$('#vcodigo1').change(function(){
				$.ajax({
					type:"post",
					data:'valor=' + $('#vcodigo1').val(),
					url:'session/',
					success:function(r){
					}
				});
...
var codivo = document.getElementById('vcodigo1').value; 
$.ajax({
