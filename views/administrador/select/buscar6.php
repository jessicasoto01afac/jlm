<?php include ("../../controller/conexion.php");
    ...
    ?>
			...
			<select class="form-control select2-show-search" disabled="" data-placeholder="Choose one (with searchbox)" onchange="desarmem()" id="arsurmem" name="arsurmem" type="text" data-live-search="true" style="width: 100%" >
	...
	<script type="text/javascript">
			...
			$('#arsurmem').change(function(){
				$.ajax({
					type:"post",
					data:'valor=' + $('#arsurmem').val(),
					url:'session/',
					success:function(r){
					}
				});
...
var codivo = document.getElementById('arsurmem').value; 
$.ajax({
