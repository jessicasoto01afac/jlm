...
$folio = $_GET['folio'];
    ...
    ?>
			<select class="form-control" disabled data-placeholder="Choose one (with searchbox)" onchange="desartic1()" id="mcodigotr3" name="mcodigotr3" type="text" data-live-search="true" style="width: 100%" >
	...
	<script type="text/javascript">
			...
			$('#mcodigotr3').change(function(){
				$.ajax({
					type:"post",
					data:'valor=' + $('#mcodigotr3').val(),
					url:'session/',
					success:function(r){
					}
				});
...
var codivo = document.getElementById('mcodigotr3').value; 
$.ajax({
