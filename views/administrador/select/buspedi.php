<?php include ("../../controller/conexion.php");
      ...
      $sql = "SELECT refe_1 FROM kardex where estado='0' AND tipo ='PEDIDO' AND status='PENDIENTE' or estado='0' AND tipo ='PEDIDO' AND status='AUTORIZADOS' GROUP BY refe_1 ORDER BY id_kax ASC";
