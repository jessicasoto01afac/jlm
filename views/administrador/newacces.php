                ...
                <div class="row mg-b-25">
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input onkeyup="mayus(this);" class="form-control inputalta" type="text" name="usunom" id="usunom" placeholder="Ingresar Nombre's">
                    </div>
                  </div><!-- col-4 -->
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label class="form-control-label label2">Apellidos: <span class="tx-danger">*</span></label>
                      <input onkeyup="mayus(this);" class="form-control inputalta" type="text" name="usuapell" id="usuapell" placeholder="Ingresa los Apellidos">
                    </div>
                  </div><!-- col-4 -->
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label class="form-control-label label2">Correo Electronico: <span class="tx-danger">*</span></label>
                      <input class="form-control inputalta" type="text" name="correo" id="correo" placeholder="ingresa@hotmail.com">
                    </div>
                  </div><!-- col-4 -->
                  <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                      <label class="form-control-label label2">Usuario: <span class="tx-danger">*</span></label>
                      <input onkeyup="mayus(this);" class="form-control inputalta" type="text" name="usuario" id="usuario" placeholder="Ingresa Usuario">
                    </div>
                  </div><!-- col-8 -->
                  <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                      <label class="form-control-label label2">Contraseña: <span class="tx-danger">*</span></label>
                      <input class="form-control inputalta" type="password" name="password" id="password"  placeholder="Ingresa Contraseña">
                    </div>
                  </div><!-- col-8 -->
                  <div class="col-lg-4">
                    <div class="form-group mg-b-10-force">
                    <label class="form-control-label label2">Privilegios: <span class="tx-danger">*</span></label>
                      <select class="form-control select2 inputalta" id="privilegios" name="privilegios" data-placeholder="Eliga una opción">
