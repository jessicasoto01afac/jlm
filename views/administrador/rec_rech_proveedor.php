...
$pprovee = mysqli_query($conexion,$sql);

$sql1 = "SELECT id_per,usunom,usuapell FROM accesos WHERE estado = 0";
$peronss = mysqli_query($conexion,$sql1);
...
<head>
    ...
    <title>JLM|Proveeedor-Reclamos/Rechazos</title>
    <!-- vendor css -->
    ...
    <section class="content" id="lista">
        <div class="br-mainpanel">
            <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
                <h4 class="tx-gray-800 mg-b-5">PROVEEDOR</h4>
            ...
            <div class="br-pagebody">
                <div class="br-section-wrapper">
                    ...
                    <div class="table-wrapper rounded table-responsive">
                        <table class="table display dataTable no-footer" id="proveeedoreslis" name="proveeedoreslis"
                            style="width:100%">
                            <thead>
                                <tr>
        ...
        <div class="br-mainpanel">
            <div class="br-pageheader pd-y-15 pd-l-20">
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    <a class="breadcrumb-item" href="../administrador/rec_rech_proveedor.php">Lista reportes
                        proveedor</a>
                    <span class="breadcrumb-item active">Información del proveedor</span>
                </nav>
            </div>
            <div class="br-pagebody">
                ...
                <div class="br-section-wrapper">
                    <h6 class="">INFORMACIÓN DEL REPORTE DE PROVEEDOR</h6>
                    <form id="info-memo" method="POST">
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" style="display:none" type="text" id="folioreprove"
                                            name="folioreprove">
                                        <label class="form-control-label" id="folreportpr" name="folreportpr"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group bd-t-0-force">
                                        <label class="form-control-label" style="font-size:14px">ORDEN DE COMPRA:<span
                                                class="tx-danger">*</span></label>
                                        <input class="form-control" readonly id="infordencomp" name="infordencomp"
                                            type="text" placeholder="Orden de compra">
                                    </div>
                                </div><!-- col-4 -->
                                <div class="col-md-4">
                                    <div class="form-group bd-t-0-force">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group bd-t-0-force">
                                        <label class="form-control-label" style="font-size:14px">DEPARTAMENTO
                                            REPORTANTE: <span class="tx-danger">*</span></label>
                                        <select id="deprepr" disabled="" name="deprepr" class="form-control"
                                            data-placeholder="Choose country">
                                            <option value="">SELECCIONA UNA OPCIÓN</option>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group bd-t-0-force">
                                        <label class="form-control-label" style="font-size:14px">PROVEEDOR: <span
                                                class="tx-danger">*</span></label>
                                        <select disabled class="form-control" name="infrepprovee" id="infrepprovee"
                                            style="font-size:16px" data-placeholder="Choose country">
                                            <option label="">Selecciona</option>
                                            <?php while($prov = mysqli_fetch_row($pprovee)):?>
                                ...
                                <div class="col-md-4 mg-t--1 mg-md-t-0">
                                    <div class="form-group mg-md-l--1">
                                        <label class="form-control-label" style="font-size:14px">PERSONA QUE REPORTA
                                            :<span class="tx-danger">*</span></label>
                                        <select id="perreprt" disabled="" name="perreprt" class="form-control"
                                            data-placeholder="Choose country">
                                            <option label="">Selecciona</option>
                                            <?php while($perj = mysqli_fetch_row($peronss)):?>
                                            <option value="<?php echo $perj[0]?>"><?php echo $perj[1].' '.$perj[2] ?>
                                            </option>
                                            <?php endwhile; ?>
                                        </select>
                                    </div><!-- col-4 -->
                        ...
                        <section>
                            <div class="row mg-b-25">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 class="form-control-label">DERSCRIPCION BREVE DEL REPORTE:</h6>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label style="font-size:16px" class="form-control-label">FECHA: <span
                                                class="tx-danger">*</span></label>
                                        <input onkeyup="mayus(this);" readonly class="form-control" name="datesegu"
                                            id="datesegu" placeholder="Departamento" type="date" required>
                                    </div><!-- form-group -->
                                </div><!-- form-group -->
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="font-size:16px" class="form-control-label">DEPARTAMENTO: <span
                                                class="tx-danger">*</span></label>
                                        <input onkeyup="mayus(this);" class="form-control" name="departseg"
                                            id="departseg" placeholder="Departamento" type="text" required readonly>
                                    </div><!-- form-group -->
                                </div><!-- form-group -->
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        <label style="font-size:16px" class="form-control-label">ENVIO A: <span
                                                class="tx-danger">*</span></label>
                                        <input onkeyup="mayus(this);" class="form-control" name="departevio"
                                            id="departevio" placeholder="Departamento" type="text" required readonly>
                                    </div><!-- form-group -->
                                </div><!-- form-group -->
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input onkeyup="mayus(this);" class="form-control" name="teldep" id="teldep"
                                            placeholder="TELEFONO" type="number" required readonly>
                                    </div><!-- form-group -->
                                </div><!-- form-group -->
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label style="font-size:16px" class="form-control-label">E-MAIL: <span
                                                class="tx-danger">*</span></label>
                                        <input onkeyup="" class="form-control" name="email" id="email"
                                            placeholder="E-MAIL" type="mail" required readonly>
                                    </div><!-- form-group -->
                                </div><!-- form-group -->
                                <div class="col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <h6 class="form-control-label">RESULTADO: </h6>
