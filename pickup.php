    ...
    <div class="bg-gray-200 md:overflow-hidden">
        <div class="px-4 py-6">
            <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                <h1 class="font-bold text-gray-700 text-xl sm:text-2xl md:text-3xl leading-tight mb-6">
                    Rastrea tu pedido
                </h1>
