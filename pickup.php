        ...
        <div class="px-4 py-6">
            <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                ...
                <div class="flex w-full justify-center items-end">
                    ...
                    <button type="button" onclick="searchpickup()"
                ...
                <p class="text-sm mt-2 text-gray-200 mb-8 w-full">Ingresa el número de rastreo</p>
            ...
            <section class="bg-white dark:bg-gray-900 px-6 py-6 mx-auto">
                <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                    ...
                    <div class="flex flex-col items-center mt-8 xl:items-start xl:w-1/2 xl:mt-0">
                        ...
                        <p class="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">En esta pagina podras consultar
                            el estatus de envio de tu pedido que realizaste en <b>Jose Luis Mondragon y compañia, SA de
                                CV </b>, si se rquiere de información adicional llamar al departamento de ventas</p>
                    ...
                    <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                ...
                                <p class="leading-relaxed">VHS cornhole pop-up, try-hard 8-bit iceland helvetica.
                                    Kinfolk
